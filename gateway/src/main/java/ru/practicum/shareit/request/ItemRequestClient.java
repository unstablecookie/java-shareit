...
public class ItemRequestClient extends BaseClient {
    ...
    public ResponseEntity<Object> updateItemRequest(Long userId, ItemRequestDto itemRequestDto, Long itemRequestId) {
        return patch("/" + itemRequestId, userId, itemRequestDto);
    }
